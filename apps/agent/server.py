...
routes = [
    ...
    Route("/api/health",                        route_tokenization,  methods=ANY_METHOD),
    Route("/api/auth",                          route_tokenization,  methods=ANY_METHOD),
    Route("/api/auth/{path:path}",              route_tokenization,  methods=ANY_METHOD),
